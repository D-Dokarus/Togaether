...
public class NotificationFacade {
    ...
    public List<Notification> getAllNotificationsOfUser(User user){
        ...
        try{
            notifications = notificationDB.findNotificationsByUserId(user.getIdUser());
    ...
    public void deleteNotification(Notification notification){
        ...
        try{
            notificationDB.deleteNotificationById(notification.getIdNotif());
        }catch(SQLException e){
            System.out.println(e);
        }
    ...
    public int getNbNotificationsByUserId(User user){
        ...
        try{
            res = notificationDB.getNbNotificationByUserId(user.getIdUser());
        }catch (SQLException e){
            System.out.println(e);
        }
        return res;
    ...
    public List<Notification> getSpecificAmountOfNotificationsByUserIdAndStartingId(User user, int limit, int min){
        ...
        try{
            notifications = notificationDB.getSpecificAmountOfNotificationsByUserIdAndStartingId(user.getIdUser(),limit,min);
        }catch (SQLException e){
            System.out.println(e);
        }
        return notifications;
