...
public class Notification {
     ...
     * @param specialId
     */
    public Notification(int idNotif, User to, User from, String contentNotif, boolean accept, NotificationCategory catNotification, int specialId) {
    ...
    public String toString() {
        ...
        res += "La valeur du champ " + "IdNotif" + " est : " + this.getIdNotif()+ "\n";
    ...
    public static  void main(String args[]){
        ...
        Notification t1 = new Notification(1,u1,u2,"Demande de d'ami Dorian => Maxime",true,n1,u2.getIdUser());
        Notification t5 = new Notification(u1,u2,"Demande de d'ami Dorian => Maxime",true,n1,u2.getIdUser());
        Notification t2 = new Notification(u1,"Message Server",true,n1,u2.getIdUser());
