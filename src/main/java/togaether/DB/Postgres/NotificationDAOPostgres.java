        ...
        try (Connection connection = this.postgres.getConnection()){
            ...
            if(notification.getFrom() != null && notification.getSpecialId() != 0){
                ...
                try(PreparedStatement statement =
                    ...
                    statement.setInt(1,notification.getTo().getIdUser());
                    statement.setInt(2,notification.getFrom().getIdUser());
    ...
    public void updateNotification(Notification notification) throws SQLException{
        try(Connection connection = this.postgres.getConnection()){
            if(notification.getTo() != null){
                ...
                try(PreparedStatement statement = connection.prepareStatement(query)){
                    statement.setInt(7,notification.getIdNotif());
                    statement.setInt(1,notification.getTo().getIdUser());
                ...
                try(PreparedStatement statement = connection.prepareStatement(query)){
                    statement.setInt(6,notification.getIdNotif());
                    if(notification.getFrom() != null){
                        statement.setInt(1,notification.getFrom().getIdUser());
                    }else{
